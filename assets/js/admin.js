...
<head>
  ...
  <link rel="stylesheet" href="../../assets/css/davar.css">
</head>
<body>
<header class="site-header" data-header><a class="skip-link" href="#main">Saltar al contenido</a><div class="nav-shell container-wide"><a class="brand" href="../../es/" aria-label="Inversiones Davar"><img src="../../assets/img/logo-mark.webp" alt="" width="46" height="46"><span class="brand-copy"><strong>Inversiones Davar</strong><small>S.A. de C.V.</small></span></a><nav class="desktop-nav" aria-label="Navegación principal"><a href="../../es/">Inicio</a><div class="nav-dropdown"><a class="nav-parent" href="../../es/florida/">Florida <i class="fa-solid fa-chevron-down"></i></a><div class="nav-dropdown-menu"><a href="../../es/florida/palm-beach/"><i class="fa-solid fa-water"></i>Palm Beach</a><a href="../../es/florida/loxahatchee/"><i class="fa-solid fa-house"></i>Loxahatchee</a><a href="../../es/florida/aventura/"><i class="fa-solid fa-building"></i>Aventura</a></div></div><a href="../../es/propiedades/">Propiedades</a><a href="../../es/honduras/">Honduras</a><a class="is-active" href="../../blog/">Blog</a><a href="../../es/#contacto">Contacto</a></nav><a class="lang-switch" href="../../" hreflang="en" lang="en"><i class="fa-solid fa-globe"></i> EN</a><a class="btn btn-primary btn-sm nav-cta" href="../../es/#contacto">Hablar con un asesor</a><button class="menu-toggle" type="button" data-menu-open aria-label="Menú" aria-expanded="false"><i class="fa-solid fa-bars"></i></button></div><div class="mobile-backdrop" data-menu-backdrop></div><aside class="mobile-menu" data-mobile-menu aria-hidden="true"><div class="mobile-menu-head"><span>Menú</span><button class="menu-close" type="button" data-menu-close aria-label="Cerrar menú"><i class="fa-solid fa-xmark"></i></button></div><nav class="mobile-nav"><a href="../../es/">Inicio</a><a href="../../es/florida/">Florida</a><a href="../../es/propiedades/">Propiedades</a><a href="../../es/honduras/">Honduras</a><a href="../../blog/">Blog</a><a href="../../es/#contacto">Contacto</a></nav><div class="mobile-actions"><a class="mobile-lang" href="../../" hreflang="en"><i class="fa-solid fa-globe"></i> English</a><a class="btn btn-primary btn-full" href="../../es/#contacto">Hablar con un asesor</a></div></aside></header>`;

  const commonFooter = () => `<footer class="footer"><div class="container-wide footer-grid"><div class="footer-brand"><div class="footer-brand-row"><img src="../../assets/img/logo-mark.webp" alt="" width="54" height="54" loading="lazy"><strong>Inversiones Davar</strong></div><p>Portafolio inmobiliario y acompañamiento para evaluar oportunidades en Florida y Honduras.</p></div><div><h3>Explorar</h3><div class="footer-links"><a href="../../es/florida/">Florida</a><a href="../../es/propiedades/">Propiedades</a><a href="../../es/honduras/">Honduras</a><a href="../../blog/">Blog inmobiliario</a></div></div><div><h3>Ubicaciones</h3><div class="footer-links"><a href="../../es/florida/palm-beach/">Palm Beach</a><a href="../../es/florida/loxahatchee/">Loxahatchee</a><a href="../../es/florida/aventura/">Aventura</a></div></div><div><h3>Contacto</h3><div class="footer-links"><a href="tel:+13059304423">+1 (305) 930-4423</a><a href="tel:+50494774954">+504 9477-4954</a><a href="https://wa.me/13059304423" target="_blank" rel="noopener">WhatsApp</a><a href="mailto:realestate.davar@gmail.com">realestate.davar@gmail.com</a><a href="../../politica-privacidad.html">Privacidad</a><a href="../../terminos-condiciones.html">Términos</a></div></div></div><div class="footer-bottom container-wide"><p>© 2026 Inversiones Davar S.A. de C.V.</p><p>Developed by <a href="https://edevisraga.com" target="_blank" rel="noopener">Edevis Raga</a></p></div></footer><button class="floating-whatsapp" type="button" data-whatsapp aria-label="WhatsApp"><i class="fa-brands fa-whatsapp"></i></button><script defer src="../../assets/js/davar.js"></script></body></html>`;
  ...
  const articleTemplate = (post, domain) => {
    ...
    return `${commonHeader(post.seoTitle || `${post.title} | Inversiones Davar`, post.description, post.image, canonical)}<script type="application/ld+json">${JSON.stringify(articleJson)}</script><main id="main"><section class="article-hero"><div class="container article-hero-inner"><nav class="breadcrumbs" aria-label="Breadcrumb"><a href="../../es/">Inicio</a><i class="fa-solid fa-chevron-right"></i><a href="../../blog/">Blog</a><i class="fa-solid fa-chevron-right"></i><span>${escapeHtml(post.category || 'Blog')}</span></nav><span class="eyebrow">${escapeHtml(post.category || 'Blog')}</span><h1>${escapeHtml(post.title)}</h1><p>${escapeHtml(post.description)}</p><div class="article-meta"><span><i class="fa-regular fa-calendar"></i>${escapeHtml(post.date || today())}</span><span><i class="fa-regular fa-circle-user"></i>${escapeHtml(post.author || 'Inversiones Davar')}</span></div></div></section><section class="article-media-section"><div class="container"><figure class="article-cover-new"><img src="../../${post.image}" alt="${escapeHtml(post.imageAlt || post.title)}" loading="eager" decoding="async"></figure></div></section><section class="section article-section"><div class="container article-layout-new"><aside class="article-aside"><a class="article-side-cta" href="../../es/#contacto"><i class="fa-brands fa-whatsapp"></i><span><strong>¿Quieres orientación?</strong>Habla con un asesor Davar.</span></a></aside><div class="article-prose"><article class="article-content">${post.contentHtml}</article><div class="article-end"><span>¿Quieres evaluar una oportunidad?</span><a class="btn btn-primary" href="../../es/#contacto">Solicitar asesoría</a></div></div></div></section><section class="section blog-cta-section"><div class="container blog-cta"><div><span class="eyebrow light">Próximo paso</span><h2>Convierte la información en una decisión.</h2><p>Explora propiedades disponibles o solicita orientación personalizada.</p></div><div class="blog-cta-actions"><a class="btn btn-light" href="../../es/propiedades/">Ver propiedades</a><a class="btn btn-gold" href="../../es/#contacto">Hablar con un asesor</a></div></div></section></main>${commonFooter()}`;
  };
  ...
  const buildSitemap = async (domain) => {
    ...
    const staticPages = ['', 'es/', 'properties/', 'es/propiedades/', 'florida/', 'es/florida/', 'florida/palm-beach/', 'es/florida/palm-beach/', 'florida/loxahatchee/', 'es/florida/loxahatchee/', 'florida/aventura/', 'es/florida/aventura/', 'honduras/', 'es/honduras/'];
    const propertyPages = state.properties.filter(p => p.status !== 'draft').flatMap(p => [p.routes?.en, p.routes?.es]).filter(Boolean).map(u => u.replace(/^\/+/, ''));
    const urls = [...staticPages, ...propertyPages, ...state.blog.filter(p => p.status !== 'draft').map(p => p.url || `blog/${p.slug}/`)];
  ...
  qs('[data-property-form]')?.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      refreshSummary();
      setStatus('Propiedad guardada en data/properties.json. Ejecuta python scripts/build-redesign.py antes de publicar para reconstruir las rutas bilingües.');
    } catch (error) {
