...
<header class="site-header" data-header>
  ...
  <div class="nav-shell container-wide"><a class="brand" href="/es/" aria-label="Inversiones Davar"><img src="../../assets/img/logo-davar.webp" alt="Logo de Inversiones Davar S.A. de C.V." width="96" height="96" decoding="async"><span><strong>Inversiones Davar</strong><small>S.A. de C.V.</small></span></a><nav class="desktop-nav" aria-label="Menú principal"><a href="/es/">Inicio</a><a href="/es/">Nosotros</a><a href="/es/florida/">Inversiones</a><a href="/es/propiedades/">Proyectos</a><a href="/es/">Recursos</a><a href="../../blog/index.html">Blog</a><a href="/es/#contacto">Contacto</a></nav><a class="translate-btn desktop-translate" href="/" aria-label="English version" ><i class="fa-solid fa-language" aria-hidden="true"></i><span>EN</span></a><a class="btn btn-small btn-gold nav-cta" href="/es/#contacto">Agenda una Asesoría</a><button class="menu-toggle" type="button" aria-label="Abrir menú" aria-controls="mobile-menu" aria-expanded="false" data-menu-open><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7h16M4 12h16M4 17h16" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/></svg></button></div>
  <div class="mobile-backdrop" data-menu-backdrop></div><aside class="mobile-menu" id="mobile-menu" aria-hidden="true" inert aria-label="Menú principal" data-mobile-menu><div class="mobile-menu-head"><span>Menú principal</span><button class="menu-close" type="button" aria-label="Cerrar menú" data-menu-close><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m6 6 12 12M18 6 6 18" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/></svg></button></div><a class="translate-btn mobile-translate" href="/" aria-label="English version" ><i class="fa-solid fa-language" aria-hidden="true"></i><span>English</span></a><nav><a href="/es/">Inicio</a><a href="/es/">Nosotros</a><a href="/es/florida/">Inversiones</a><a href="/es/propiedades/">Proyectos</a><a href="/es/">Recursos</a><a href="../../blog/index.html">Blog</a><a href="/es/#contacto">Contacto</a></nav><a class="btn btn-gold btn-full" href="/es/#contacto">Agenda una Asesoría</a></aside>
</header>`;

  const commonFooter = () => `<footer class="footer"><div class="container-wide footer-grid"><div class="footer-brand"><img src="../../assets/img/logo-davar.webp" alt="Inversiones Davar" width="80" height="80" loading="lazy" decoding="async"><p>Firma inmobiliaria enfocada en conectar inversionistas latinoamericanos con oportunidades estratégicas en Florida.</p></div><div><h3>Navegación</h3><div class="footer-links"><a href="/es/">Inicio</a><a href="/es/">Nosotros</a><a href="/es/florida/">Inversiones</a><a href="/es/propiedades/">Proyectos</a><a href="/es/">Recursos</a><a href="../../blog/index.html">Blog</a><a href="/es/#contacto">Contacto</a></div></div><div><h3>Contacto</h3><div class="footer-links footer-contact"><a href="tel:+13059304423">+1 (305) 930-4423</a><a href="https://wa.me/13059304423" target="_blank" rel="noopener">WhatsApp</a><a href="mailto:realestate.davar@gmail.com">realestate.davar@gmail.com</a></div></div><div><h3>Legal</h3><div class="footer-links"><a href="../../politica-privacidad.html">Política de privacidad</a><a href="../../terminos-condiciones.html">Términos</a></div></div></div><div class="footer-bottom container-wide"><p>Inversiones Davar 2026 - Derechos Reservados - Desarrollado por <a href="https://edevisraga.com" target="_blank" rel="noopener">Edevis Raga</a></p></div></footer><button class="floating-whatsapp" type="button" data-whatsapp aria-label="Contactar por WhatsApp"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 19 6.1 16.1A8 8 0 1 1 9 18.9L5 19Z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M9 8.8c.4 2.6 2.4 4.6 5 5l1.4-1.4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg></button><script defer src="../../assets/js/app.js"></script></body></html>`;
